...
@Component({
  selector: 'app-seminar-events',
  templateUrl: './seminar-events.component.html',
  styleUrls: ['./seminar-events.component.css']
})
export class SeminarEventsComponent implements OnInit {
