...
@Component({
  selector: 'app-seminar-reservation',
  templateUrl: './seminar-reservation.component.html',
  styleUrls: ['./seminar-reservation.component.css']
})
export class SeminarReservationComponent implements OnInit {
...
setTimeout(() => {
  this.router.navigate(['/seminar']); // Route users to blog page
}, 3000);
    }
...
console.log("rooms haven't been posted for this date yet");
  ...
  console.log("no rooms have been booked for seminar room and whatever floor has been selected.");
  this.rest=true;
