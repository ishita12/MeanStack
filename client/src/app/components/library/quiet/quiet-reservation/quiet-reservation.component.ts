...
@Component({
  selector: 'app-quiet-reservation',
  templateUrl: './quiet-reservation.component.html',
  styleUrls: ['./quiet-reservation.component.css']
})
export class QuietReservationComponent implements OnInit {
...
setTimeout(() => {
  this.router.navigate(['/quiet']); // Route users to blog page
}, 3000);
    }
...
console.log("rooms haven't been posted for this date yet");
  ...
  console.log("no rooms have been booked for Quiet room and whatever floor has been selected.");
  this.rest=true;
