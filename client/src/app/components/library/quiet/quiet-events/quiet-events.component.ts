...
@Component({
  selector: 'app-quiet-events',
  templateUrl: './quiet-events.component.html',
  styleUrls: ['./quiet-events.component.css']
})
export class QuietEventsComponent implements OnInit {
